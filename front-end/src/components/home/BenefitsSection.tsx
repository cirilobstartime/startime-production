...
export default async function BenefitsSection({ locale }: Props) {
  ...
  // Featured project
  const FEATURED_PROJECT = "eed1hhu2k8jkad75a7gpo9rq"; // Replace with your project's documentId

  const featured = projectsData.find(
    (project: any) => project.documentId === FEATURED_PROJECT
  );
            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <h3
                    className={`text-lg font-bold text-[#5b4180] mb-3 leading-tight line-clamp-2 min-h-[3rem] ${
